...
const en = {
  ...
  home: {
    ...
    why: {
      ...
      cards: [
        ...
        ['Track it offline', 'The mobile app keeps plans, active sessions, and performed logs on-device.'],
    ...
    screens: {
      eyebrow: 'App screens',
      title: 'Real Universal Fit screens, not placeholder fitness art.',
      intro: 'The public site now shows the same dark training surface users see when they import, generate, track, and tune their plans.',
      cards: [
        ['Library', 'Find current, past, and archived plans from one compact shelf.', 'Universal Fit library screen showing searchable workout plans.'],
        ['Import plans', 'Preview example plans, import from a file, or paste JSON directly.', 'Universal Fit import plan screen showing example workout cards.'],
        ['AI plan flow', 'Copy a structured prompt, ask an assistant, then paste the JSON back into the app.', 'Universal Fit custom plan screen showing the AI prompt workflow.'],
        ['History', 'Review weekly streaks, PRs, cardio, volume, and calendar progress.', 'Universal Fit history screen showing training calendar and streak stats.'],
        ['Settings', 'Keep units, body weight, available plates, language, and workout preferences close.', 'Universal Fit settings screen showing units and plate controls.'],
      ],
    },
    examples: {
      eyebrow: 'Examples',
  ...
  privacy: {
    ...
    intro: 'Universal Fit is designed around local files and on-device training logs. The public website is static.',
    cards: [
      ['Local app data', 'Workout plans and training logs are handled on-device for core app features.'],
...
const es: PageMessages = {
  ...
  home: {
    ...
    why: {
      ...
      cards: [['Trae tu propio plan', 'Importa JSON de un coach, un exportador de hojas de cálculo, un repo de GitHub o un prompt.'], ['Entrena sin conexión', 'La app móvil mantiene planes, sesiones activas y registros realizados en el dispositivo.'], ['Es solo JSON', 'La validación estricta hace que los planes sean inspeccionables, compartibles, versionables y fáciles de corregir.']],
    },
    builder: {
      eyebrow: 'Constructor',
    ...
    screens: {
      ...
      title: 'Pantallas reales de Universal Fit, no arte genérico de fitness.',
      intro: 'El sitio público ahora muestra la misma superficie oscura que los usuarios ven al importar, generar, seguir y ajustar sus planes.',
      cards: [
        ['Biblioteca', 'Encuentra planes actuales, pasados y archivados desde una vista compacta.', 'Pantalla de biblioteca de Universal Fit con planes de entrenamiento buscables.'],
        ['Importar planes', 'Previsualiza ejemplos, importa desde archivo o pega JSON directamente.', 'Pantalla de importación de Universal Fit con tarjetas de planes de ejemplo.'],
        ['Flujo con IA', 'Copia un prompt estructurado, pregunta a un asistente y pega el JSON en la app.', 'Pantalla de plan personalizado de Universal Fit con flujo de prompt de IA.'],
        ['Historial', 'Revisa rachas semanales, PRs, cardio, volumen y progreso de calendario.', 'Pantalla de historial de Universal Fit con calendario y estadísticas de racha.'],
        ['Ajustes', 'Mantén cerca unidades, peso corporal, discos disponibles, idioma y preferencias.', 'Pantalla de ajustes de Universal Fit con controles de unidades y discos.'],
      ],
    },
...
Object.assign(pt, {
  ...
  home: {
    ...
    why: {
      ...
      cards: [
        ...
        ['Treine offline', 'O app móvel mantém planos, sessões ativas e registros realizados no dispositivo.'],
    ...
    screens: {
      ...
      title: 'Telas reais do Universal Fit, não arte genérica de fitness.',
      intro: 'O site público agora mostra a mesma superfície escura que os usuários veem ao importar, gerar, acompanhar e ajustar seus planos.',
      cards: [
        ['Biblioteca', 'Encontre planos atuais, passados e arquivados em uma prateleira compacta.', 'Tela da biblioteca do Universal Fit com planos de treino pesquisáveis.'],
        ['Importar planos', 'Pré-visualize exemplos, importe de um arquivo ou cole JSON diretamente.', 'Tela de importação do Universal Fit com cartões de planos de exemplo.'],
        ['Fluxo com IA', 'Copie um prompt estruturado, pergunte a um assistente e cole o JSON de volta no app.', 'Tela de plano personalizado do Universal Fit mostrando o fluxo de prompt de IA.'],
        ['Histórico', 'Revise sequências semanais, PRs, cardio, volume e progresso no calendário.', 'Tela de histórico do Universal Fit com calendário de treino e estatísticas de sequência.'],
        ['Configurações', 'Mantenha unidades, peso corporal, anilhas, idioma e preferências de treino por perto.', 'Tela de configurações do Universal Fit com controles de unidades e anilhas.'],
      ],
    },
    examples: {
      eyebrow: 'Exemplos',
  ...
  privacy: {
    ...
    intro: 'Universal Fit foi desenhado em torno de arquivos locais e registros de treino no dispositivo. O site público é estático.',
    cards: [
      ['Dados locais do app', 'Planos e registros de treino são tratados no dispositivo para as funções principais.'],
...
Object.assign(fr, {
  ...
  home: {
    ...
    why: {
      ...
      cards: [
        ...
        ['Entraînez-vous hors ligne', 'L’app mobile garde les programmes, sessions actives et journaux réalisés sur l’appareil.'],
    ...
    screens: {
      ...
      title: 'De vrais écrans Universal Fit, pas des visuels fitness génériques.',
      intro: 'Le site public montre maintenant la même interface sombre que les utilisateurs voient pour importer, générer, suivre et ajuster leurs programmes.',
      cards: [
        ['Bibliothèque', 'Retrouvez les programmes actifs, passés et archivés dans une vue compacte.', 'Écran bibliothèque Universal Fit avec programmes d’entraînement recherchables.'],
        ['Importer des programmes', 'Prévisualisez des exemples, importez un fichier ou collez directement du JSON.', 'Écran d’import Universal Fit avec cartes de programmes exemples.'],
        ['Flux IA', 'Copiez un prompt structuré, demandez à un assistant, puis recollez le JSON dans l’app.', 'Écran de programme personnalisé Universal Fit montrant le flux de prompt IA.'],
        ['Historique', 'Consultez séries hebdo, records, cardio, volume et progression calendrier.', 'Écran historique Universal Fit avec calendrier d’entraînement et statistiques de série.'],
        ['Réglages', 'Gardez unités, poids corporel, disques disponibles, langue et préférences à portée.', 'Écran réglages Universal Fit avec contrôles d’unités et de disques.'],
      ],
    },
    examples: {
      eyebrow: 'Exemples',
  ...
  privacy: {
    ...
    intro: 'Universal Fit est conçu autour de fichiers locaux et de journaux d’entraînement sur l’appareil. Le site public est statique.',
    cards: [
      ['Données locales de l’app', 'Les programmes et journaux d’entraînement sont gérés sur l’appareil pour les fonctions principales.'],
...
Object.assign(de, {
  ...
  home: {
    ...
    why: {
      ...
      cards: [
        ...
        ['Offline trainieren', 'Die mobile App hält Pläne, aktive Sessions und Logs auf dem Gerät.'],
    ...
    screens: {
      eyebrow: 'App-Bildschirme',
      title: 'Echte Universal Fit Screens statt generischer Fitnessbilder.',
      intro: 'Die öffentliche Website zeigt jetzt dieselbe dunkle Trainingsoberfläche, die Nutzer beim Importieren, Generieren, Tracken und Anpassen ihrer Pläne sehen.',
      cards: [
        ['Bibliothek', 'Finde aktuelle, frühere und archivierte Pläne in einer kompakten Ansicht.', 'Universal Fit Bibliotheksbildschirm mit durchsuchbaren Trainingsplänen.'],
        ['Pläne importieren', 'Sieh Beispielpläne an, importiere Dateien oder füge JSON direkt ein.', 'Universal Fit Importbildschirm mit Beispielkarten für Trainingspläne.'],
        ['KI-Ablauf', 'Kopiere einen strukturierten Prompt, frage einen Assistenten und füge JSON zurück in die App ein.', 'Universal Fit Bildschirm für individuelle Pläne mit KI-Prompt-Ablauf.'],
        ['Verlauf', 'Prüfe Wochenserien, PRs, Cardio, Volumen und Kalenderfortschritt.', 'Universal Fit Verlaufsbildschirm mit Trainingskalender und Serienstatistiken.'],
        ['Einstellungen', 'Halte Einheiten, Körpergewicht, Scheiben, Sprache und Trainingspräferenzen griffbereit.', 'Universal Fit Einstellungsbildschirm mit Einheiten- und Scheibenkontrollen.'],
      ],
    },
    examples: {
      eyebrow: 'Beispiele',
  ...
  privacy: {
    ...
    intro: 'Universal Fit ist um lokale Dateien und Trainingslogs auf dem Gerät herum konzipiert. Die öffentliche Website ist statisch.',
    cards: [
      ['Lokale App-Daten', 'Trainingspläne und Logs werden für die Kernfunktionen auf dem Gerät verarbeitet.'],
...
Object.assign(it, {
  ...
  home: {
    ...
    why: {
      ...
      cards: [
        ...
        ['Allenati offline', 'L’app mobile mantiene piani, sessioni attive e log eseguiti sul dispositivo.'],
    ...
    screens: {
      eyebrow: 'Schermate app',
      title: 'Schermate reali di Universal Fit, non immagini fitness generiche.',
      intro: 'Il sito pubblico ora mostra la stessa superficie scura che gli utenti vedono quando importano, generano, tracciano e regolano i propri piani.',
      cards: [
        ['Libreria', 'Trova piani correnti, passati e archiviati da una vista compatta.', 'Schermata libreria Universal Fit con piani allenamento ricercabili.'],
        ['Importa piani', 'Anteprima esempi, importa da file o incolla JSON direttamente.', 'Schermata importazione Universal Fit con schede di piani esempio.'],
        ['Flusso IA', 'Copia un prompt strutturato, chiedi a un assistente e incolla il JSON nell’app.', 'Schermata piano personalizzato Universal Fit con flusso prompt IA.'],
        ['Cronologia', 'Rivedi streak settimanali, PR, cardio, volume e progresso calendario.', 'Schermata cronologia Universal Fit con calendario allenamenti e statistiche streak.'],
        ['Impostazioni', 'Tieni vicini unità, peso corporeo, dischi disponibili, lingua e preferenze.', 'Schermata impostazioni Universal Fit con controlli unità e dischi.'],
      ],
    },
    examples: {
      eyebrow: 'Esempi',
  ...
  privacy: {
    ...
    intro: 'Universal Fit è progettato attorno a file locali e log allenamento sul dispositivo. Il sito pubblico è statico.',
    cards: [
      ['Dati locali dell’app', 'Piani e log di allenamento vengono gestiti sul dispositivo per le funzioni principali.'],
